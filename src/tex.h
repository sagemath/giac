...
namespace giac {
  ...
  extern std::string tex_preamble;
  extern std::string tex_end;
  extern std::string mbox_begin,mbox_end;
  class gen;
  ...
  extern unary_function_ptr at_graph2tex ;
  gen _graph3d2tex(const gen & args,GIAC_CONTEXT);
  extern unary_function_ptr at_graph3d2tex ;
  gen _latex(const gen & args,GIAC_CONTEXT);
  extern unary_function_ptr at_latex ;
  extern unary_function_ptr at_TeX ;
